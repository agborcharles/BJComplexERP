...
class Employee(models.Model):
    ...
    firstname = models.CharField(('First Name'),max_length=125,null=False,blank=False)
    lastname = models.CharField(('Last Name'),max_length=125,null=False,blank=False)
    ...
    def save(self, *args, **kwargs):
            self.slug = slugify(self.firstname +' '+ self.lastname +' '+self.middle_name)
