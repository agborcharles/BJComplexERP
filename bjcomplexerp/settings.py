"""
Django settings for bjcomplexerp project.
...
SECRET_KEY = 'django-insecure-qw-+zi(m(43^kp4pt*e#(@t$wap-l0lst0)4*ll6y0ywq^2h)-'
...
ROOT_URLCONF = 'bjcomplexerp.urls'
...
WSGI_APPLICATION = 'bjcomplexerp.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'bjcomplex_django', # database name
        'USER': 'root', #username
        'PASSWORD': 'yannick50', #password
        'HOST': 'localhost',
        'PORT': '3306',
    }
}
